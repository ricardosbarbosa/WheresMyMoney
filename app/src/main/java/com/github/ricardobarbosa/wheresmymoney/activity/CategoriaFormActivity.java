...
import com.github.ricardobarbosa.wheresmymoney.fragment.CategoriaFormFragment;
...
public class CategoriaFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CategoriaFormFragment formFragment;

        Fragment retainedFragment = fm.findFragmentByTag(FORM_FRAGMENT_KEY);
        if (retainedFragment != null && retainedFragment instanceof CategoriaFormFragment) {
            formFragment = (CategoriaFormFragment) retainedFragment;
        } else {
            formFragment = new CategoriaFormFragment();
            fm.beginTransaction()
    ...
    private void setSubmitAction(final CategoriaFormFragment formFragment) {
