...
public class ContaFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ContaFormFragment formFragment;

        Fragment retainedFragment = fm.findFragmentByTag(FORM_FRAGMENT_KEY);
        if (retainedFragment != null && retainedFragment instanceof ContaFormFragment) {
            formFragment = (ContaFormFragment) retainedFragment;
        } else {
            formFragment = new ContaFormFragment();
            fm.beginTransaction()
    ...
    private void setSubmitAction(final ContaFormFragment formFragment) {
