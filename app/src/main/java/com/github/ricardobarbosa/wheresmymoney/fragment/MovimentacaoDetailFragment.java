...
import com.github.ricardobarbosa.wheresmymoney.activity.MovimentacaoListActivity;
...
public class MovimentacaoDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.movimentacao_detail)).setText(mItem.details);
        }
